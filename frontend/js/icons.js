// 极简内联图标集：不依赖外部图标库，按钮尺寸仍由 CSS 统一控制。
...
const PATHS = {
  ...
  dice: '<rect x="3" y="3" width="18" height="18" rx="2"></rect><circle cx="8" cy="8" r="1"></circle><circle cx="16" cy="8" r="1"></circle><circle cx="8" cy="16" r="1"></circle><circle cx="16" cy="16" r="1"></circle><circle cx="12" cy="12" r="1"></circle>',
  shield: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>',
  bag: '<path d="M6 2h12l2 6H4l2-6z"></path><path d="M4 8h16v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8z"></path>',
...
export function icon(name, label = "") {
  ...
  return `<svg class="icon" viewBox="0 0 24 24" ${aria}>${body}</svg>`;
}
